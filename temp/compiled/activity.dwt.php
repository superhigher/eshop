...
<link rel="shortcut icon" href="ecmoban_vjia/favicon.ico" />
<link rel="icon" href="ecmoban_vjia/animated_favicon.gif" type="image/gif" />
...
?>
      <table border="0" style="float:left;">
        <tr>
          <td align="center"><a href="ecmoban_vjia/goods.php?id=<?php echo $this->_var['goods']['id']; ?>"><img src="<?php echo $this->_var['goods']['thumb']; ?>" alt="<?php echo $this->_var['goods']['name']; ?>" /></a></td>
        </tr>
        <tr>
          <td align="center"><a href="ecmoban_vjia/goods.php?id=<?php echo $this->_var['goods']['id']; ?>" class="f6"><?php echo $this->_var['goods']['name']; ?></a></td>
        </tr>
        <tr>
          <td align="center">
